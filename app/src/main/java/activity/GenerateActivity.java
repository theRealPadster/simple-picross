...
public class GenerateActivity extends AppCompatActivity {
     ...
     */
        ...
        final GestureDetector mGestureDetector = new GestureDetector(GenerateActivity.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    */
    ...
    public void onTouchDrawer(final int position){
        if (position != getCurrFrag()) { //TODO - re-tool logic here, make it grab it from active fragment somehow
            ...
            switch (position)
            {
                ...
                default:
                    ...
                    Toast.makeText(GenerateActivity.this, "The item clicked is: " + position, Toast.LENGTH_SHORT).show();
                    fragmentClass = main_menu.class;
                    break;
            }
        ...
        {
           Toast.makeText(GenerateActivity.this, "Already on page: " + position, Toast.LENGTH_SHORT).show();
        }
    }
